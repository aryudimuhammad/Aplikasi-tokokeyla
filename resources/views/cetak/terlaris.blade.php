...
<head>
    ...
    <title>Laporan Data Barang Terlaris</title>
...
<body>
    ...
    <div class="container" style="margin-top:-40px;">
        <h4 style="text-align:center;text-transform: uppercase;">Laporan Data Barang Terlaris </h4>
        <table class="table table-bordered nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="col" class="text-center">{{Carbon\Carbon::parse($d->updated_at)->format('d/m/Y')}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
